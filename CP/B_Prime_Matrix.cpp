...
public:
    ...
    mii samAllPrimes(int samN)
    {
        ...
        samPrimeStatus[0] = 0;samPrimeStatus[1] = 0;
...
public:
    ...
    //    while ( t-- ){
        ...
        vector<vector<int>> pv(n, vector<int>(m));
        vector<vector<int>> dv(n, vector<int>(m));
